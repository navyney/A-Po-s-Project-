...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// progressBar1
			// 
			this->progressBar1->Location = System::Drawing::Point(1601, 816);
			this->progressBar1->Name = L"progressBar1";
			this->progressBar1->Size = System::Drawing::Size(189, 63);
			...
			// NEXT
			// 
			this->NEXT->Location = System::Drawing::Point(1601, 904);
