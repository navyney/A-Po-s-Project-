...
namespace allmodel {
	...
	/// <summary>
	/// Summary for newconsonant
	/// </summary>
	public ref class newconsonant : public System::Windows::Forms::Form
	{
	public:
		newconsonant(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(newconsonant::typeid));
			...
			this->nextbutton->Click += gcnew System::EventHandler(this, &newconsonant::nextbutton_Click);
			// 
			// previousbutton
			// 
			...
			this->previousbutton->Click += gcnew System::EventHandler(this, &newconsonant::previousbutton_Click);
			// 
			// pictureBox1
			// 
			...
			this->f->TabIndex = 150;
			this->f->Text = L"f ฟัว";
			this->f->Click += gcnew System::EventHandler(this, &newconsonant::f_Click);
			// 
			// msound
			// 
			...
			this->Name = L"newconsonant";
			this->Text = L"newconsonant";
