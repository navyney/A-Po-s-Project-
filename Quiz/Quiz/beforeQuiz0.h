...
namespace Quiz {
	...
	/// <summary>
	/// Summary for before_Quiz0
	/// </summary>
	public ref class beforeQuiz0 : public System::Windows::Forms::Form
	{
	public:
		beforeQuiz0(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(beforeQuiz0::typeid));
			...
			this->button2->Click += gcnew System::EventHandler(this, &beforeQuiz0::button2_Click);
			// 
			// button3
			// 
